...
with st.sidebar:
    st.header("配置")
    model_options = ("r2+1d_100", "r3d_100", "LSTM_100", "r2+1d_500", "r3d_500", "LSTM_500","SignFormer_100")
...
if is_valid:
    ...
    if st.button(':cake:开始识别'):
        ...
        st.write("Prediction index", ida)
        st.write("Prediction word: ", prediction[0][0])
        st.title("TOP-5 Likely Word ")
