    ...
    if st.sidebar.button('开始'):
        try:
            ...
            if (selected_model == "r2+1d_100") | (selected_model == "r2+1d_500"):
                ...
                model.load_state_dict(torch.load(model_path))
                model.eval()
            elif (selected_model == "SignFormer_100") | (selected_model == "SignFormer_500"):
                model_path = "weight/" + str(selected_model) + "/" + str(selected_weight)
                model = SignFormer(num_classes=num_classes).cuda()
            ...
            if (selected_model == "SignFormer_100") | (selected_model == "SignFormer_500"):
            ...
            while (cap.isOpened()):
                ...
                if success:
                    ...
                    st_frame.image(image, caption='Real Video', channels="BGR", use_container_width=True)
                    if(max(softmax)>SOFTMAX_THRES):
                        cnt = 0
